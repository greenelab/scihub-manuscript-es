...
El estudio de 2016 titulado "¿Quién está descargando documentos pirateados? Todos ” analizó un conjunto de datos de registros de acceso de Sci-Hub [@doi:10.1126/science.352.6285.508; @doi:10.1126/science.aaf5664]. Alexandra Elbakyan trabajó con el periodista John Bohannon para producir un conjunto de datos de las solicitudes resueltas de Sci-Hub desde el 1 de septiembre de 2015 hasta el 29 de febrero de 2016 [@doi:10.5061/dryad.q447c/1]. En noviembre de 2015, el nombre de dominio de Sci-Hub fue suspendido como resultado de una acción legal de Elsevier [@url:https://torrentfreak.com/sci-hub-and-libgen-resurface-after-being-shut-down-151121/; @doi:10.1038/nature.2015.18876]. Según Bohannon, esto resultó en "una brecha de 18 días en los datos a partir del 4 de noviembre de 2015 cuando el dominio sci-hub.org se cayó y los registros del servidor se configuraron incorrectamente". Mostramos este tiempo de inactividad en la Figura @fig:history.
...
Filtramos los eventos de acceso excluyendo los DOI no incluidos en nuestro catálogo de literatura y omitiendo los registros que ocurrieron antes de la fecha de publicación de un artículo. Este filtro conservó 26,984,851 eventos de acceso para 10,293,836 DOI distintos (97.5% de los 10,552,418 DOI pre filtrados distintos). Resumimos los eventos de acceso para cada artículo utilizando las siguientes métricas:
...
A continuación, calculamos las métricas de acceso a nivel de revista en base a los artículos publicados desde el 1 de enero de 2014 hasta el inicio de los registros de acceso de Sci-Hub el 1 de septiembre de 2015. Para cada revista, calculamos los valores promedio para las cinco métricas de registro de acceso descrito arriba. Curiosamente, la revista _Medicina - Programa de Formación Médica Continuada Acreditado_ [recibió](https://greenelab.github.io/scihub/#/journal/21100213100 "Sci-Hub Stats Browser page for the journal Medicine") la mayor cantidad de visitantes por artículo, con un promedio de 33.4 visitantes por cada uno de sus 326 artículos.
...
Tenga en cuenta que estos análisis no incluyen los registros de acceso de Sci-Hub para 2017 [@doi:10.5281/zenodo.1158301], que se [publicaron](https://twitter.com/Sci_Hub/status/954095639859814402) el 18 de enero de 2018. Desafortunadamente, en ese momento ya habíamos adoptado un congelamiento de principales análisis nuevos. No obstante, hicimos un análisis rápido para evaluar el crecimiento de las descargas de Sci-Hub a lo largo del tiempo que combinó los datos de registro de acceso de 2015-2016 y 2017 (Figura @fig:downloads).
