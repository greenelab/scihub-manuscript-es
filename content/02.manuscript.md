...
En este estudio, utilizamos el término "acceso de pago" (también conocido como "acceso cerrado") para referirnos a la literatura detrás de muros de pago [@isbn:9780262517638]. 
...
Como resultado, cientos de universidades han cancelado todas las suscripciones de Elsevier [@doi:10.1038/nature.2016.21223; @doi:10.1038/d41586-018-00093-7]. 
Estos eventos hacen eco de las predicciones de los abogados de Elsevier en 2015 [@url:https://www.courtlistener.com/docket/4355308/6/elsevier-inc-v-sci-hub/]: “Las acciones de los acusados también amenazan con un daño irreparable inminente para Elsevier porque pareciera que el repositorio de la “Proyecto Biblioteca Génesis” puede estar llegando (o eventualmente se acercará) a un nivel de 'integridad' donde pueda servir como un reemplazo funcionalmente equivalente, aunque evidentemente ilegal, para ScienceDirect”.
...
Los bibliotecarios confían en las métricas de uso y los comentarios de los usuarios para evaluar las suscripciones [@doi:10.1300/J123v18n01_09]. 
Sci-Hub podría disminuir el uso de las suscripciones de la biblioteca, ya que muchos usuarios lo encuentran más conveniente que el acceso autorizado [@doi:10.1126/science.aaf5704]. 
...
La publicación de preprints y postprints ha crecido rápidamente [@doi:10.7287/peerj.preprints.3119v1; @doi:10.1126/science.aaq0747], con nuevas herramientas de búsqueda para ayudar a localizarlas [@doi:10.1038/d41586-017-05922-9]. 
La tendencia de aumentar la disponibilidad verde está destinada a continuar a medida que los financiadores [exijan](https://roarmap.eprints.org/) las postprints [@doi:10.1038/508161a] y las preprints ayuden a los investigadores a evitar el lento camino de la publicación académica tradicional [@doi:10.1038/530148a]. 
...
En palabras de Alexandra Elbakyan [@url:https://engineuring.wordpress.com/2016/02/24/why-sci-hub-is-the-true-solution-for-open-access-reply-to-criticism/]: 
...
La transición a la disponibilidad gratuita de artículos académicos está actualmente en curso, y dicho modelo puede ser inevitable a largo plazo [@doi:10.5860/crl-299; @doi:10.5860/crln.72.11.8671; @url:https://www.theguardian.com/science/2012/jun/08/open-access-research-inevitable-nature-editor]. 
Sin embargo, instamos a la comunidad a aprovechar esta oportunidad para liberar completamente los artículos académicos, así como explorar modelos comerciales más constructivos para la publicación [@doi:10.3233/978-1-61499-769-6-118; @doi:10.1126/science.aap7562; @doi:10.12688/f1000research.11415.2]. 
Solo el acceso libre, habilitado por licencias abiertas, permite crear aplicaciones sobre la literatura académica sin temor a consecuencias legales [@url:http://blog.dhimmel.com/biorxiv-licenses/]. 
Por ejemplo, el minado de texto completo de la literatura académica es un área de gran potencial [@doi:10.1101/162099], pero actualmente no es práctico debido a la falta de un corpus de artículos preprocesados a gran escala. 
Las barreras aquí son legales, no tecnológicas [@doi:10.1045/november14-brook; @doi:10.1038/483134a]. 
...
Las visualizaciones frontend utilizan [Vega-Lite](https://vega.github.io/vega-lite/) [@doi:10.1109/TVCG.2016.2599030]. 
...
Este sistema, desarrollado originalmente para [Deep Review](https://github.com/greenelab/deep-review) permite la escritura colaborativa en GitHub [@doi:10.1101/142760], utiliza análisis continuo para obtener metadatos de referencia y reconstruir el manuscrito frente a cambios [@doi:10.1038/nbt.3780].
...
La iniciativa DOI comenzó en 1997, y los primeros DOI se registraron en 2000 [@doi:10.1000/182; @doi:10.1016/j.serrev.2007.05.006].
Tenga en cuenta que los DOI pueden registrarse de forma retroactiva. 
Por ejemplo, el descubrimiento de protistas y bacterias de Antony van Leewenhoeck, publicado en 1677 por _Philosophical Transactions de la Royal Society of London_ [@doi:10.1098/rstl.1677.0003], tiene un DOI (`10.1098/rstl.1677.0003`), asignado retroactivamente en 2006.
...
Al evaluar la presencia de DOI en otras bases de datos de literatura académica (como PubMed, Web of Science y Scopus), los investigadores estiman que alrededor del 90% de los artículos recientemente publicados en las ciencias tienen DOI [@doi:10.1016/j.joi.2015.11.008; @doi:10.1007/s11192-016-2225-6]. 
La prevalencia de los DOI varía según la disciplina y el país de publicación, con una asignación de DOI en artículos recientemente publicados en artes y humanidades de alrededor del 60% [@doi:10.1016/j.joi.2015.11.008]. 
De hecho, el registro de DOI es casi totalmente inexistente para los editores de muchos países de Europa del Este [@doi:10.1007/s11192-016-2225-6]. 
Además, la prevalencia de la asignación de DOI es probablemente menor para los artículos más antiguos [@doi:10.1007/s11192-016-2225-6].
...
Un aspecto a menudo ignorado del sistema DOI es que los DOI no distinguen entre mayúsculas y minúsculas dentro del rango de caracteres ASCII [@doi:10.1000/182; @doi:10.3403/30177056]. 
...
Si bien el manual de DOI establece que "todos los nombres de DOI se convierten en mayúsculas al registrarse" [@doi:10.1000/182], utilizamos en minúsculas los DOI de acuerdo con el proceder de Crossref. 
...
Crossref es una agencia de registro de DOI (una entidad capaz de asignar DOI) para publicaciones académicas [@doi:10.6087/kcse.2014.1.13]. 
...
En marzo de 2015, de los 1,464,818 enlaces de DOI válidos en la versión en inglés de Wikipedia, el 99.9% estaban registrados en Crossref [@doi:10.1007/978-3-319-49304-6_40]. 
...
Debido al gran tamaño del archivo (7,4 GB), la exportación de la base de datos MongoDB de metadatos DOI no está disponible en GitHub, y en su lugar se aloja a través de figshare [@doi:10.6084/m9.figshare.4816720.v1]. 
...
Tenga en cuenta que Scopus no indexa todas las revistas académicas [@doi:10.1007/s11192-015-1765-5], que es una de las razones por las cuales el 30.5% de los artículos (24,853,345 DOI) no eran atribuibles a una revista.
...
En comparación con Sci-Hub, las operaciones de LibGen son más opacas, ya que los contribuyentes mantienen un perfil bajo y no contactan con periodistas [@url:https://engineuring.wordpress.com/2017/07/02/some-facts-on-sci-hub-that-wikipedia-gets-wrong/]. 
LibGen alberga varias colecciones, incluidos repositorios distintos para libros y libros de texto científicos, libros de ficción y cómics [@doi:10.1002/asi.23445]. 
En 2012, LibGen agregó la base de datos "scimag" para la literatura académica. 
Desde la primavera de 2013, Sci-Hub ha subido artículos que obtiene a scimag LibGen [@url:https://engineuring.wordpress.com/2017/07/02/some-facts-on-sci-hub-that-wikipedia-gets-wrong/]. 
...
[Importamos](https://github.com/greenelab/scihub/issues/2) el volcado de SQL a MySQL y luego exportamos la tabla de scimag a un archivo TSV [@doi:10.6084/m9.figshare.5231245.v1]. 
...
Sin embargo, cuando comparamos nuestro gráfico con uno generado a partir del volcado de SQL de la base de datos de scimag de LibGen el 1 de enero de 2014 [@doi:10.1002/asi.23445; @doi:10.6084/m9.figshare.4906367.v1], notamos una gran discrepancia. 
...
Por ejemplo, Cabanac escribe [@doi:10.1002/asi.23445]: 
...
Es probable que tales colecciones masivas de artículos resulten de fugas bibliográficas [@doi:10.2196/jmir.3331], pero uno solo puede especular sobre esto debido a la fuente indocumentada de cada archivo almacenado en caché en LibGen”. 
...
El número de artículos agregados por día para el volcado de la base de datos LibGen del 1 de enero de 2014 fue [proporcionado](https://github.com/greenelab/scihub/issues/8#issuecomment-296719787) por Cabanac y corresponde a la Figura 1 de @doi:10.1002/asi.23445.
...
[oaDOI](https://oadoi.org/), abreviatura de DOI de acceso abierto, es un servicio que determina si un DOI está disponible de forma gratuita en algún lugar en línea [@url:http://blog.impactstory.org/introducting-oadoi/]. 
oaDOI no indexa artículos publicados en redes sociales académicas o disponibles en repositorios ilícitos como Sci-Hub [@doi:10.7287/peerj.preprints.3119v1]. 
Utilizando la infraestructura de oaDOI, el estudio del estado de OA investigó la disponibilidad de artículos de tres colecciones ([@doi:10.7287/peerj.preprints.3119v1]. 
...
[Unpaywall](http://unpaywall.org/) es una extensión de navegador web que notifica a su usuario si un artículo está disponible a través de oaDOI [@doi:10.1038/nature.2017.21765]. 
...
El estudio del estado de OA determinó el estado de accesibilidad de cada DOI en cada colección utilizando oaDOI [@doi:10.7287/peerj.preprints.3119v1; @doi:10.5281/zenodo.837902]. 
...
OpenCitations es un recurso de dominio público que contiene datos de citas académicas [@doi:10.1108/JD-12-2013-0166]. 
OpenCitations extrae su información del subconjunto de acceso abierto de PubMed Central. 
En el repositorio de [greenelab/opencitations](https://github.com/greenelab/opencitations), procesamos la publicación de datos OpenCitations del 25 de julio de 2017 [@doi:10.6084/m9.figshare.3443876.v3; @doi:10.6084/m9.figshare.5255365.v1; @doi:10.6084/m9.figshare.5255368.v1], creando un catálogo de referencias bibliográficas DOI – citas – DOI. 
...
El estudio de 2016 titulado "¿Quién está descargando documentos pirateados? Todos ” analizó un conjunto de datos de registros de acceso de Sci-Hub [@doi:10.1126/science.352.6285.508; @doi:10.1126/science.aaf5664]. 
Alexandra Elbakyan trabajó con el periodista John Bohannon para producir un conjunto de datos de las solicitudes resueltas de Sci-Hub desde el 1 de septiembre de 2015 hasta el 29 de febrero de 2016 [@doi:10.5061/dryad.q447c/1]. 
En noviembre de 2015, el nombre de dominio de Sci-Hub fue suspendido como resultado de una acción legal de Elsevier [@url:https://torrentfreak.com/sci-hub-and-libgen-resurface-after-being-shut-down-151121/; @doi:10.1038/nature.2015.18876]. 
...
Tenga en cuenta que estos análisis no incluyen los registros de acceso de Sci-Hub para 2017 [@doi:10.5281/zenodo.1158301], que se [publicaron](https://twitter.com/Sci_Hub/status/954095639859814402) el 18 de enero de 2018. 
...
Los registros de acceso de Sci-Hub se combinaron a partir de dos versiones: @doi:10.5061/dryad.q447c/1 que abarca 27.819.963 descargas de septiembre de 2015 a febrero de 2016 y @doi:10.5281/zenodo.1158301 que abarca 150.875.862 descargas de 2017.
...
La caída de las descargas de diciembre de 2017 probablemente refleja el efecto de las suspensiones de dominio que ocurrieron a fines de noviembre [@url:http://www.theregister.co.uk/2017/11/23/scihubs_become_inactive_following_court_order/].
...
Es probable que esta notable cobertura refleje que estos artículos fueron publicados entre 2009 y 2015 y que Web of Science los clasificó como elementos citables, que es selectivo al indexar revistas [@doi:10.1007/s11192-015-1765-5].
...
Es probable que estas anomalías resulten de errores tanto en PennText (cuya precisión estimamos en 88.2%) como en oaDOI (cuya precisión del estudio del Estado de OA estimó en 90.4%, es decir, la Tabla 1 de @doi:10.7287/peerj.preprints.3119v1 informa 5 falsos positivos y 43 falsos negativos en detecciones oaDOI para 500 artículos).
