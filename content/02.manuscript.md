...
Los histogramas muestran la distribución de la cobertura de Sci-Hub para las 23.037 revistas (arriba) y 3.832 editores (abajo). Cada contenedor abarca 2.5 puntos porcentuales. Por ejemplo, la barra superior izquierda indica que la cobertura de Sci-Hub está entre 0.0% –2.5% para 3,892 revistas.
