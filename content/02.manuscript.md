...
Tabla: **Cobertura para las diez revistas con más artículos.**
El número total de artículos publicados por cada revista se anota en la columna Crossref. La tabla proporciona el número (columna de Sci-Hub) y el porcentaje (columna de cobertura) de estos artículos que se encuentran en el repositorio de Sci-Hub.
