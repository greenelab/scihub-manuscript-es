...
El 19 de marzo de 2017, Sci-Hub [tuiteó](https://twitter.com/Sci_Hub/status/843546352219017218): "Si le interesa la lista de todos los DOI recopilados en Sci-Hub, aquí está: sci-hub.cc/downloads/doi.7z ... 62,835,101 DOI en orden alfabético". El tweet incluyó un enlace de descarga para un archivo con los 62,835,101 DOIs a los que Sci-Hub dice que proporciona acceso. De estos DOI, 56,246,220 eran parte del catálogo de artículos académicos derivado de Crossref, y el 99.5% de los DOI de la lista de Sci-Hub estaban en el repositorio de scimag LibGen (después del filtrado). Por lo tanto, los depósitos de Scimag y Sci-Hub de LibGen se han mantenido sincronizados en gran medida desde su separación. En Twitter, la cuenta Sci-Hub confirmó este hallazgo, comentando "con pequeñas diferencias, sí, la base de datos es la misma". Por lo tanto, los catálogos LibGen scimag y Sci-Hub DOI se pueden usar de manera intercambiable para fines de investigación.
...
[oaDOI](https://oadoi.org/), abreviatura de DOI de acceso abierto, es un servicio que determina si un DOI está disponible de forma gratuita en algún lugar en línea [@url:http://blog.impactstory.org/introducting-oadoi/]. oaDOI no indexa artículos publicados en redes sociales académicas o disponibles en repositorios ilícitos como Sci-Hub [@doi:10.7287/peerj.preprints.3119v1]. Utilizando la infraestructura de oaDOI, el estudio del estado de OA investigó la disponibilidad de artículos de tres colecciones ([@doi:10.7287/peerj.preprints.3119v1]. Cada colección consta de una muestra aleatoria de aproximadamente 100,000 artículos de un corpus más grande. Describimos las colecciones a continuación e informamos el número de artículos después de la intersección con nuestro catálogo DOI:
...
[Unpaywall](http://unpaywall.org/) es una extensión de navegador web que notifica a su usuario si un artículo está disponible a través de oaDOI [@doi:10.1038/nature.2017.21765]. Dado que la colección Unpaywall se basa en artículos que los usuarios visitaron, es un mejor reflejo de las necesidades reales de acceso de los académicos contemporáneos. Desafortunadamente, dado que el número de visitas por artículo no se conserva en este conjunto de datos, las estimaciones de la tasa de cumplimiento están sesgadas en relación con los artículos muy visitados y se convierten en una variante de escala (afectada por la popularidad de Unpaywall).
...
El estudio del estado de OA determinó el estado de accesibilidad de cada DOI en cada colección utilizando oaDOI [@doi:10.7287/peerj.preprints.3119v1; @doi:10.5281/zenodo.837902]. Los artículos para los cuales oaDOI no identificó un texto completo se consideraron "cerrados". De lo contrario, a los artículos se les asignó un color/estado de bronce, verde, híbrido u oro. oaDOI clasifica los artículos que no están disponibles en el sitio de su editorial como verdes o cerrados. La versión de oaDOI utilizada en el estudio del estado de OA identificó artículos verdes al buscar en PubMed Central y <abbr title="Bielefeld Academic Search Engine">BASE</abbr>. Los lectores deben tener en cuenta que esta implementación [probablemente cuenta menos](https://github.com/greenelab/scihub-manuscript/issues/36) que los artículos verdes, especialmente si consideran los artículos disponibles de las redes sociales académicas como verdes.
